...
Welcome to the Peer and Nutanix add-on lab! This workbook accompanies an instructor-led session that introduces Nutanix and Peer software workong together.

You will explore using Peer with Nutanix.
